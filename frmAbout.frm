...
Begin VB.Form frmAbout 
   ...
   Caption         =   "About WA1ZEK Telnet DX Cluster Client"
   ClientHeight    =   4485
   ClientLeft      =   2340
   ClientTop       =   1935
   ClientWidth     =   7485
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Height          =   945
      Left            =   5640
      MouseIcon       =   "frmAbout.frx":1D1B
      MousePointer    =   99  'Custom
      Picture         =   "frmAbout.frx":2025
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   3360
      Width           =   1260
   ...
   Begin VB.Label websiteLabel 
      ...
      Height          =   375
      Left            =   120
      MouseIcon       =   "frmAbout.frx":232F
      MousePointer    =   99  'Custom
      TabIndex        =   7
      ToolTipText     =   "Click to send browser to my web site"
      Top             =   4080
      Width           =   4815
   End
   Begin VB.Label emalLabel 
      Alignment       =   2  'Center
      Caption         =   "Mark Mokoski, WA1ZEK / VK2IFH"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   12
         Charset         =   0
   ...
   Begin VB.Label lblTitle 
      Caption         =   "WA1ZEK Telnet DX Cluster Client"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   9.75
         Charset         =   0
